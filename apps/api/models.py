...
class LogWx(models.Model):
    ...
    type = models.CharField(max_length=2,default='0',verbose_name='错误类型')
    # 0:cron_gift_compare_order;1:send_temp, 2:cron_gift_change_balance, 3:CardEditView,
    # 4:UploadPageView,5:upCode,6:giftcard_pay_done,7:CardDelView,8:modifyCardStock
